 ...
 * @author DELL
 */
public class NhanVienJFrane extends javax.swing.JFrame {
    ...
    /**
     * Creates new form NhanVienJFrane
     */
    public NhanVienJFrane() {
        initComponents();
        setLocationRelativeTo(null);
        this.setDefaultCloseOperation(NhanVienJFrane.DISPOSE_ON_CLOSE);
        this.load();
        this.setStatus(true);
    }
    ...
    void delete() {
        ...
        if (DialogHelper.confirm(this, "Bạn thực sự muốn xóa nhân viên này?")) {
            ...
            try {
                ...
                DialogHelper.alert(this, "Xóa thất bại! Không xoá chính mình!");
            }
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NhanVienJFrane.class
